...
global.botname = "Octopus-Bot"
global.image = fs.readFileSync("./settings/Octopus2.jpg")
global.thumbnail = fs.readFileSync("./settings/Octopus.jpg") //sesuaikan dengan nama foto
